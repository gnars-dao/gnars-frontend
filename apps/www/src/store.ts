...
const skateContract = new web3.eth.Contract(
  SkateContractAbi as AbiItem[],
  SKATE_ADDRESS
)
const skateSettleContract = new web3.eth.Contract(
  SkateSettleContractAbi as AbiItem[],
  SKATE_SETTLE_ADDRESS
)
const skateContractV2 = new web3.eth.Contract(
  SkateContractV2Abi as AbiItem[],
  SKATE_V2_ADDRESS
)
