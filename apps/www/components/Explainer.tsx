          ...
          <div className="pb-12">
            ...
            <div className="flex flex-col gap-8 pt-8 pb-10 mb-10 border-b-2 border-borderColor">
              <p>
                ...
                generation and distribution mechanism, auctioning one Gnar every
                10 minutes, then less often, forever. As per the supply curve
                diagram shown above, auction duration doubles every 1000th Gnar,
                known as “The Gnarving” and in effect halving the supply
                emission each time.
              </p>
              <p>
                Auction proceeds (ETH) are automatically sent to the Gnars DAO
                treasury and to our founder 0xigami.eth, depending on what
                balance you set with the bid slider. You can even choose not to
                reward the founder if you wish. Funds received to the treasury
                are governed by Gnar owners.
              </p>
              <p>
                Each time an auction is settled, the settlement transaction will
                also cause a new Gnar to be minted and a new auction to begin.
                While settlement is most heavily incentivized for the
            ...
            <div className="flex flex-col gap-8 pt-8 pb-10 mb-10 border-b-2 border-borderColor">
              <div className="flex flex-col">
                ...
                <div>
                  ...
                  current Gnar to the winner’s wallet. As gas prices fluctuate,
                  the cost of settlement also fluctuates.
                </div>
              </div>
              <div>
                Cost of settlement for every Gnar ID ending in 6 is higher as it
                consumes more gas. This is due to the transaction also
                triggering the free Gnar mint: all Gnars ending in 7 are sent to
                the treasury and held on behalf of the Nouns Athletes.
              </div>
              <div className="flex flex-col">
                ...
                <div>
                  ...
                  onwards). Anyone can bid an amount at/above 0.011 ETH. If your
                  bid is outbid by someone else, the full amount of your bid
                  (minus gas spent to bid) is returned to you in the same
              ...
              <div>
                ...
                are sent at the same time, but only one will be accepted by the
            ...
            <div className="flex flex-col gap-8 pt-8 pb-10 mb-10 border-b-2 border-borderColor">
              ...
              <p>
                ...
                but delegatable, which means you can assign your vote to someone
                else as long as you own your Gnar.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-8 pt-8 pb-10 mb-10 border-b-2 border-borderColor">
              <p>
                ...
                There are no 'if' statements or other rules governing Gnar trait
                scarcity, which makes all Gnars equally rare. As of this
              ...
              <p>
                ...
                Playground (soon), or browse through different traits by using
                filters on your favorite NFT marketplace.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-8 pt-8 pb-10 mb-10 border-b-2 border-borderColor">
              ...
              <p>
                ...
                string concatenation. Once the entire SVG has been generated, it
                is base64 encoded.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-8 pt-8 pb-10 mb-10 border-b-2 border-borderColor">
              <p>
                ...
                the minting process. The seeder contract can be replaced to
                allow for future trait generation algorithm upgrades.
                Additionally, it can be locked by the Gnars DAO to prevent any
                future updates. Currently, Gnar traits are determined using
            ...
            <div className="flex flex-col gap-8 pt-8 pb-10 mb-10 border-b-2 border-borderColor">
              ...
              <p>
                ...
                50/50 split meaning that half of your bid, if successful, would
                be deposited to 0xigami.eth during settlement.
              </p>
              <p>
