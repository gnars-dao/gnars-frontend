 ...
 */
export const getAuctionCacheKey = "GNARS_AUCTION_CACHE"

/**
 * Key mapped to the last processed bid
 */
export const getBidCacheKey = "GNARS_BID_CACHE"

/**
 * Key mapped to the tweet id to reply updates to
 */
export const getReplyTweetIdKey = "GNARS_REPLY_TWEET_ID"

/**
 * Key mapped to the latest auction id processed for auction ending soon
 */
export const getAuctionEndingSoonCacheKey = "GNARS_AUCTION_ENDING_SOON_CACHE"

/**
 * Key prefix for caching proposal records
 */
export const getProposalCacheKeyPrefix = "GNARS_PROPOSAL_"

/**
 * Key prefix for caching proposal expiry warning sent records
 */
export const getProposalExpiryWarningSentCacheKeyPrefix =
  "GNARS_PROPOSAL_EXPIRY_WARNING_SENT_"
