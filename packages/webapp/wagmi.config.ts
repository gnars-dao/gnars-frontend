...
const gnarsV2AuctionHouseABI = [
  ...
  },
  {
    ...
    name: "auction",
    outputs: [
      { internalType: "uint256", name: "gnarId", type: "uint256" },
      { internalType: "uint256", name: "amount", type: "uint256" },
      { internalType: "uint256", name: "startTimestamp", type: "uint256" },
      { internalType: "uint256", name: "endTimestamp", type: "uint256" },
      { internalType: "address payable", name: "bidder", type: "address" },
      { internalType: "uint8", name: "skatePercent", type: "uint8" },
      { internalType: "uint8", name: "daoPercent", type: "uint8" },
  ...
  },
  {
    ...
    name: "gnars",
    outputs: [
      { internalType: "contract ISkateContractV2", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      { internalType: "address", name: "_skate", type: "address" },
      ...
      { internalType: "uint256", name: "_baseAuctionTime", type: "uint256" },
      { internalType: "uint256", name: "_timeDoublingCount", type: "uint256" },
    ],
    name: "initialize",
    outputs: [],
