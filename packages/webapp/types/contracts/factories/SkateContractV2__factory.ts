...
import type {
  SkateContractV2,
  SkateContractV2Interface,
} from "../SkateContractV2";
...
export class SkateContractV2__factory {
  static readonly abi = _abi;
  static createInterface(): SkateContractV2Interface {
    return new utils.Interface(_abi) as SkateContractV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SkateContractV2 {
    return new Contract(address, _abi, signerOrProvider) as SkateContractV2;
  }
}
