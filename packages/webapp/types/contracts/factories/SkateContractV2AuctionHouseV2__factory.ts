...
import type {
  ...
  SkateContractV2AuctionHouseV2Interface,
} from "../SkateContractV2AuctionHouseV2";
...
export class SkateContractV2AuctionHouseV2__factory {
  static readonly abi = _abi;
  static createInterface(): SkateContractV2AuctionHouseV2Interface {
    return new utils.Interface(_abi) as SkateContractV2AuctionHouseV2Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as SkateContractV2AuctionHouseV2;
  }
}
