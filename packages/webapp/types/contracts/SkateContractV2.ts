...
export declare namespace IGnarSeederV2 {
...
export interface SkateContractV2Interface extends utils.Interface {
  functions: {
    ...
    "customDescription(uint256)": FunctionFragment;
    ...
    "initialGnarId()": FunctionFragment;
    ...
    "setCustomDescription(uint256,string)": FunctionFragment;
    ...
    "viewDescription(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "customDescription",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "initialGnarId",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setCustomDescription",
  ...
  encodeFunctionData(
    functionFragment: "viewDescription",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "GnarBurned(uint256)": EventFragment;
    "GnarCreated(uint256,tuple)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "GnarBurned"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "GnarCreated"): EventFragment;
...
export interface GnarBurnedEventObject {
  tokenId: BigNumber;
}
export type GnarBurnedEvent = TypedEvent<[BigNumber], GnarBurnedEventObject>;

export type GnarBurnedEventFilter = TypedEventFilter<GnarBurnedEvent>;

export interface GnarCreatedEventObject {
  tokenId: BigNumber;
  seed: IGnarSeederV2.SeedStructOutput;
}
export type GnarCreatedEvent = TypedEvent<
  [BigNumber, IGnarSeederV2.SeedStructOutput],
  GnarCreatedEventObject
>;

export type GnarCreatedEventFilter = TypedEventFilter<GnarCreatedEvent>;
...
export interface SkateContractV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SkateContractV2Interface;
  ...
  functions: {
    ...
    initialGnarId(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "GnarBurned(uint256)"(
      tokenId?: PromiseOrValue<BigNumberish> | null
    ): GnarBurnedEventFilter;
    GnarBurned(
      tokenId?: PromiseOrValue<BigNumberish> | null
    ): GnarBurnedEventFilter;

    "GnarCreated(uint256,tuple)"(
      tokenId?: PromiseOrValue<BigNumberish> | null,
      seed?: null
    ): GnarCreatedEventFilter;
    GnarCreated(
      tokenId?: PromiseOrValue<BigNumberish> | null,
      seed?: null
    ): GnarCreatedEventFilter;
  ...
  populateTransaction: {
    ...
    initialGnarId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
