...
export interface SkateContractV2AuctionHouseInterface extends utils.Interface {
  functions: {
    ...
    "initialize(address,address,address,address,uint256,uint8,uint256,uint256)": FunctionFragment;
...
export interface SkateContractV2AuctionHouse extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SkateContractV2AuctionHouseInterface;
