...
export type AuctionFragment = { __typename?: 'Auction', dao: { __typename?: 'DAO', name: string, auctionAddress: any, tokenAddress: any } };

export type AuctionBidFragment = { __typename?: 'AuctionBid', id: string, amount: any, bidder: any };
...
export type DaoOgMetadataQuery = { __typename?: 'Query', dao?: { __typename?: 'DAO', name: string, description: string, contractImage: string, totalSupply: number, ownerCount: number, proposalCount: number, tokenAddress: any, metadataAddress: any, auctionAddress: any, treasuryAddress: any, governorAddress: any } | null };
...
export type DaoTokenOwnersQuery = { __typename?: 'Query', daotokenOwners: Array<{ __typename?: 'DAOTokenOwner', dao: { __typename?: 'DAO', name: string, tokenAddress: any, auctionAddress: any, governorAddress: any } }> };
...
export type DashboardQuery = { __typename?: 'Query', daotokenOwners: Array<{ __typename?: 'DAOTokenOwner', dao: { __typename?: 'DAO', contractImage: string, name: string, tokenAddress: any, auctionAddress: any, governorAddress: any, auctionConfig: { __typename?: 'AuctionConfig', minimumBidIncrement: any, reservePrice: any }, proposals: Array<{ __typename?: 'Proposal', voteEnd: any, voteStart: any, expiresAt?: any | null, abstainVotes: number, againstVotes: number, calldatas?: string | null, description?: string | null, descriptionHash: any, executableFrom?: any | null, forVotes: number, proposalId: any, proposalNumber: number, proposalThreshold: any, proposer: any, quorumVotes: any, targets: Array<any>, timeCreated: any, title?: string | null, values: Array<any>, snapshotBlockNumber: any, transactionHash: any, votes: Array<{ __typename?: 'ProposalVote', voter: any }>, dao: { __typename?: 'DAO', governorAddress: any, tokenAddress: any } }>, currentAuction?: { __typename?: 'Auction', endTime: any, highestBid?: { __typename?: 'AuctionBid', amount: any, bidder: any } | null, token: { __typename?: 'Token', name: string, image?: string | null, tokenId: any } } | null } }> };
...
export type ExploreDaosPageQuery = { __typename?: 'Query', auctions: Array<{ __typename?: 'Auction', endTime: any, dao: { __typename?: 'DAO', name: string, tokenAddress: any }, highestBid?: { __typename?: 'AuctionBid', amount: any, bidder: any } | null, token: { __typename?: 'Token', name: string, image?: string | null, tokenId: any } }> };
...
export const ExploreDaosPageDocument = gql`
    query exploreDaosPage($orderBy: Auction_orderBy, $orderDirection: OrderDirection, $where: Auction_filter, $skip: Int, $first: Int) {
  auctions(
    where: $where
    orderBy: $orderBy
    orderDirection: $orderDirection
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    daoOGMetadata(variables: DaoOgMetadataQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DaoOgMetadataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DaoOgMetadataQuery>(DaoOgMetadataDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'daoOGMetadata', 'query');
    },
    daoTokenOwners(variables?: DaoTokenOwnersQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DaoTokenOwnersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DaoTokenOwnersQuery>(DaoTokenOwnersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'daoTokenOwners', 'query');
    },
    dashboard(variables?: DashboardQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DashboardQuery> {
    ...
    exploreDaosPage(variables?: ExploreDaosPageQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ExploreDaosPageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ExploreDaosPageQuery>(ExploreDaosPageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'exploreDaosPage', 'query');
    },
