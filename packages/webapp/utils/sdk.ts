...
/**
 * [__View Contract on Ethereum BaseScan__](https://basescan.org/address/0x880Fb3Cf5c6Cc2d7DFC13a993E839a9411200C17)
 */
export const gnarsV2TokenAddress = {
  1: '0x880Fb3Cf5c6Cc2d7DFC13a993E839a9411200C17',
} as const
...
>(
  ...
  return useContractRead({ abi: gnarsV2TokenABI, address: gnarsV2TokenAddress[1], ...config } as UseContractReadConfig<
