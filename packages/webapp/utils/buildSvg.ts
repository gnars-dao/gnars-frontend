import { GnarPart } from "./old-index";
...
export default function buildSvg(parts: GnarPart[], paletteColors: string[], bgColor?: string) {
  ...
  return `data:image/svg+xml;base64,${Buffer.from(completedSvg, "utf-8").toString("base64")}`;
}
